...
int main()
{
    ...
    cout << endl
         << "Enter the Elements for the First Array" << endl
         << endl;
    ...
    cout << endl
         << "Enter the number of elements for the second array (maximum of 10): ";
    cin >> arrTwoCount;

    cout << endl
         << "Enter the Elements for the Second Array" << endl
         << endl;
